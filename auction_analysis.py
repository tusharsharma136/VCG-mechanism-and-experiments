...
class AuctionTestSuite:
    ...
    def run_single_test(self, bids: List[Bid], test_name: str) -> Dict:
        ...
        # Convert Bid objects to dictionaries
        bid_dicts = []
        for bid in bids:
            bid_dict = {
                'bidder_id': bid.bidder_id,
                'value': bid.value,
                'space_type': bid.space_type.value  # Convert enum to string
            }
...
def analyze_results(results: Dict):
    ...
    print(f"Truthful Bid Utility: {truthful['truthful']['spa_results']['payment']}")
    print(f"Overbid Utility: {truthful['overbid']['spa_results']['payment']}")
    print(f"Underbid Utility: {truthful['underbid']['spa_results']['payment']}")
